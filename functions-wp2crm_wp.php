<?php
include_once('functions-wp2crm_template.php');
...
function custom_theme_features()  {
	...
	load_theme_textdomain( 'wp2crm', get_template_directory() . '/language' );	
}
...
function wp2crm_listing_template(){
    global $wp_query;
...
add_filter( '404_template', 'wp2crm_listing_template' );

...
jQuery("#buyerprofile").submit(function(event){
	...
	jQuery.post('/wp-content/plugins/wp2crm/_auth.php',{'query':'AJAX','action':'x2apipost','_format':'json','_method':'PATCH','_class':'Contacts/'+buyerid+'.json','_data':jsondata},function(response){

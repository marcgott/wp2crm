		...
		<div 	id="divB"
			class="theme-background2-lt property_div clearfix <?php echo $home_propertycss;?>" 
				...
				display: inline-block;">
					<?php
			$listingtxt = ($a['franchise']==true)?__("Franchise","wp2crm"):__("Listing","wp2crm");
			if($listing->c_listing_exclusive_c):	
				...
				>
					<?php 
					_e("Premiere",'wp2crm'); echo " ".$listingtxt; 
					?>
				<!--divC-->
				</div>
					<?php 
				...
				>
						<?php 
					_e("Featured",'wp2crm');echo " ".$listingtxt; 
						?>
				<!--divD-->
				</div>
		<?php 
					...
					<div id="divF">
						<ul class="">
							...
							?>
								...
								?>
							<li class="overview_detail"><?php echo __('Asking:','wp2crm').' '.$listing->c_currency_id." ".number_format(str_replace("$","",$listing->c_listing_askingprice_c)) ;?></li>
							<li class="overview_detail"><?php echo __('Gross Sales:','wp2crm').' '.$listing->c_currency_id." ".number_format(str_replace("$","",$listing->c_financial_grossrevenue_c)) ;?></li>
							<li class="overview_detail"><?php echo __('Year Established:','wp2crm').' '.$listing->c_yearEstablished; ?></li>
						</ul>
					<!--divF-->
					</div>
				<!--divE-->

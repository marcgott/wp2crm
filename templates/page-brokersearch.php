...
global $wp_query,$url,$wp2crm_option;
...
?>
    ...
    <div class="theme-color1-dk" style="display:block;margin-top:7px;" > 
      <i class="fa fa-phone-square"></i> &nbsp;<? _e('','wp2crm');?> <?php echo $phone_office; ?><br>
	  <a href="mailto:<?php echo $broker_email; ?>"><i style="padding-right:7px;" class="fa fa-envelope-o"></i> Email</a> </br>
		  ...
		  <div  class="col-md-8" style="display:inline-block;float:left; clear:none;" >
					...
					<p><span class="badge outline radius blue"> <? _e('','wp2crm');?> <?php echo $broker_position; ?><br></span></p>
					<p><?php echo $broker->description;?></p>
		            
			<form method=POST action="<?php echo get_permalink($wp2crm_option["wp2crm_pageselect_broker"]);?>">

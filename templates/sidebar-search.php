...
?>
<h3 class="theme-background" style="display:none; color:#ccc;margin:0;margin-top:10px;width:40%"><?php _e($a['title'],'wp2crm');?></h3>
...
<div class="form_group">
	<label class="theme-color" for="generic"><?php _e('Keyword/s:','wp2crm');?></label><br>
...
<div class="sidebar_categories_base_container form_group">
	<div class="sidebar_categories_button"><?php _e('Categories','wp2crm');?>
...
<?php 
	...
	$json = x2apicall(array('_class'=>'dropdowns/'.$wp2crm_option["wp2crm_crm_buscats_parents"].'.json'));
...
<div class="form_group">
	<label class="theme-color" for="downpayment"><?php _e("Minimum Investment:",'wp2crm')?></label><br>
...
<div class="form_group">
	<label class="theme-color" for="downpayment"><?php _e("Maximum Investment:",'wp2crm')?></label><br>
...
<div id="dd_state" class="dd_bystate form_group">
	<label id="regionlabel" class="theme-color" for="c_listing_region_c"><?php _e("State",'wp2crm')?></label><br />
...
<div class="form_group">
	<label class="theme-color" for="downpayment"><?php _e("Adjusted Net Profit:",'wp2crm')?></label><br>
...
<div class="form_group">
	<label class="theme-color" for="broker"><?php _e("Broker/s:",'wp2crm')?></label><br><select size="4" name="c_Broker[]" multiple="multiple" id="broker" class="broker-select"></select>
</div>
<?php
...
pleaseWaitTxt = "<?php _e("Please wait a moment...",'wp2crm');?>";
selectCountyTxt = "<?php _e("Please select a city",'wp2crm');?>";
</script>

<div class="form_group">
	<div class="checkbox_container">
		<input type="checkbox" name="c_franchise_c" value="Yes" class="franchise_checkbox"><label class="theme-color" for="c_franchise_c"><?php _e("Check for Franchise",'wp2crm')?></label>
	</div>
</div>
	...
	<div id="sebu" class="form_group">
		<button onclick="javascript: clear_business_shearch_by_id_input();" type="submit" class="btn btn-default find_business_search_button">
			<span class="glyphicon glyphicon-search"></span><?php _e('Find Business','wp2crm');?>
		</button>
